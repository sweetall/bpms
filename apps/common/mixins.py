...
class BaseMixinModelSerializer(serializers.ModelSerializer):
    ...
    def get_modifier(self, obj):
        return obj.modifier.username if obj.modifier else ''

    def get_create_time(self, obj):
        return obj.create_time.strftime('%Y-%m-%d %H:%M')

    def get_modify_time(self, obj):
        return obj.modify_time.strftime('%Y-%m-%d %H:%M') if obj.modify_time else ''
