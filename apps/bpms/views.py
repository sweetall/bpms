...
class IndexView(LoginRequiredMixin, TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        # info = {'subject': 'test', 'message': '123', 'from_email': '871568533@qq.com',
        #         'recipient_list': ['sweetalltt@yahoo.com', 'sweetall@aliyun.com']}
        # send_mail_async(**info)
        # send_mail_async.delay(**info)
